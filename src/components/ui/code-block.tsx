...
export function CodeBlock({
  ...
  return (
    <figure
      ...
      {...props}
      className={cn(
        isTab ? [bg, 'rounded-md'] : 'my-4 rounded-md bg-fd-card',
  ...
  (
    ...
    return (
      <figure
        ...
        {...props}
        className={cn(
          'not-prose group fd-codeblock relative my-6 overflow-hidden rounded-md border bg-fd-secondary/50 text-sm',
          keepBackground &&
      ...
      >
          ...
          <div className="flex flex-row items-center gap-2 border-b bg-fd-muted px-4 py-1.5">
            {icon ? (
              <div
                ...
                // biome-ignore lint/security/noDangerouslySetInnerHtmlWithChildren: this is a side effect
                // biome-ignore lint/security/noDangerouslySetInnerHtml: this is a side effect
                dangerouslySetInnerHTML={
                  typeof icon === 'string'
                    ? {
        ...
        <ScrollArea ref={areaRef} dir="ltr" className="max-h-[600px]">
          {props.children}
